...
- ~~production/page.tsx~~ 617→265L (nouveau commit, constants + types + 8 composants + hook)
...
**EN COURS** (1 partiel):
- src/app/(dashboard)/batch/page.tsx — 681→625L (types + utils extraits, reste composants UI)

**RESTANTS** (5 à traiter):
...
5. src/app/financer/page.tsx — 692L
